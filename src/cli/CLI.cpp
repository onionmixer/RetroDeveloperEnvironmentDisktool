...
void CLI::printCommandHelp(const std::string& command) const {
    ...
    if (command == "create") {
        ...
        std::cout << "  Macintosh: 80 tracks, 2 sides, 18 sectors/track, 512 bytes/sector (1440K)\n";
        std::cout << "              — supply -g 80:2:10:512 for 800K HFS\n";
        ...
        std::cout << "\nNotes:\n";
        std::cout << "  * Apple II / MSX / X68000 disks are not bootable (no boot code).\n";
        std::cout << "  * Macintosh HFS volumes get a halt-loop boot block scaffold (LK\n";
        std::cout << "    signature + Pascal name fields). They are NOT runtime-bootable\n";
        ...
        std::cout << "  ProDOS (Apple II), MSX-DOS (MSX), Human68k (X68000), HFS (Macintosh)\n";
        std::cout << "\nExamples:\n";
        std::cout << "  rdedisktool mkdir mydisk.dsk GAMES\n";
        std::cout << "  rdedisktool mkdir mydisk.dsk GAMES/RPG\n";
        std::cout << "  rdedisktool mkdir mac.img \"My Folder\"\n";
        std::cout << "\nNotes:\n";
        std::cout << "  * DOS 3.3 and MFS do not support subdirectories.\n";
        std::cout << "  * HFS supports nested mkdir; the catalog leaf is auto-split as needed.\n";
